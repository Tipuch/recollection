...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"BaseJpWordFormset.js":[function(require,module,exports) {
/*
...
function getLastFormId() {
  var $totalForms = $('input#id_form-TOTAL_FORMS');
  return $totalForms.val() - 1;
}

function addForm() {
  var $lastFormDiv = $("div#div_id_form-" + getLastFormId() + "-word");
  var $lastFormKanjis = $("input#id_form-" + getLastFormId() + "-kanjis");
  var $lastFormOwner = $("input#id_form-" + getLastFormId() + "-owner");
  var $lastFormActions = $('form#id-JpWordFormset div.form-actions');
...
function modifyLastForm() {
  var $lastFormDiv = $("div#div_id_form-" + getLastFormId() + "-word:last");
  var $lastFormKanjis = $("input#id_form-" + getLastFormId() + "-kanjis:last");
  var $lastFormOwner = $("input#id_form-" + getLastFormId() + "-owner:last");
  var newId = getLastFormId() + 1;
  $lastFormDiv.attr("id", "div_id_form-" + newId + "-word");
  $lastFormDiv.find("label:first").attr("for", "id_form-" + newId + "-word");
  var $lastFormWord = $lastFormDiv.find("input#id_form-" + getLastFormId() + "-word");
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","BaseJpWordFormset.js"], null)
//# sourceMappingURL=/BaseJpWordFormset.js.map