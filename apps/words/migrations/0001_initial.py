    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_index', models.PositiveIntegerField(default=0, verbose_name='Question Index')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.PositiveIntegerField(default=7, verbose_name='Frequency in days')),
                ('number_of_questions', models.PositiveIntegerField(default=20, verbose_name='Number of questions')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('words', models.ManyToManyField(to='words.JapaneseWord', verbose_name='Words')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='questions_as_choices', to='words.JapaneseWord', verbose_name='Choices')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='words.englishword', verbose_name='Question')),
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='words.jpquiz', verbose_name='Quiz')),
                ('right_answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions_as_answer', to='words.japaneseword', verbose_name='Right answer')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='words.japaneseword', verbose_name='Answer')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Owner')),
                ('question', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='answer', to='words.jpquizquestion', verbose_name='Question')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='jpquiz',
            name='quiz_template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='words.jpquiztemplate', verbose_name='Quiz Template'),
        ),
        migrations.AddField(
