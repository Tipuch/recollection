...
class OwnershipAdminMixin(admin.ModelAdmin):
    ...
    def change_view(self, request, object_id, **kwargs):
        ...
        return super(OwnershipAdminMixin, self).change_view(request, object_id, **kwargs)
    ...
    def delete_view(self, request, object_id, **kwargs):
        ...
        return super(OwnershipAdminMixin, self).delete_view(request, object_id, **kwargs)
    ...
    def history_view(self, request, object_id, **kwargs):
        ...
        return super(OwnershipAdminMixin, self).history_view(request, object_id, **kwargs)
